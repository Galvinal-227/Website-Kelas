...
const ErrorPage = () => {
  useEffect(() => {
    console.log("Starting Yeti Animation");
    const lettersColorLight = "#37a8e9ff";  
    const lettersColorDark = "#2c445bff";  
    const strokeColorLight = "#1E4568";  
    const strokeColorDark = "#0F2A40";    
    
    const furColorLight = "#E8F4FC";    
    const furColorDark = "#fcfcfcff";     
    const skinColorLight = "#C4E2F2";  
    const skinColorDark = "#b1e1ffff";   
    ...
    function setDarkMode() {
      gsap.set("#four04 path", { 
        fill: lettersColorDark,
        stroke: strokeColorDark 
      });
      
      gsap.set(".hlFur", { fill: furColorDark });
      gsap.set(".hlSkin", { fill: skinColorDark });
      gsap.set("#lettersShadow", { opacity: 0.05 });
    }
    
    function setLightMode() {
      gsap.set("#four04 path", { 
        fill: lettersColorLight,
        stroke: strokeColorLight 
      });
      
      gsap.set(".hlFur", { fill: furColorLight });
      gsap.set(".hlSkin", { fill: skinColorLight });
      gsap.set("#lettersShadow", { opacity: 0.15 });
    }
    
    setDarkMode();
    const lightTimeline = gsap.timeline({repeat: -1});
    ...
    console.log("Animations started - Dimmed flashlight effect!");
  }, []);
